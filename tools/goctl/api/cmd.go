...
import (
	...
	"github.com/5a6e/newzero/tools/goctl/api/apigen"
	"github.com/5a6e/newzero/tools/goctl/api/dartgen"
	"github.com/5a6e/newzero/tools/goctl/api/docgen"
	"github.com/5a6e/newzero/tools/goctl/api/format"
	"github.com/5a6e/newzero/tools/goctl/api/gogen"
	"github.com/5a6e/newzero/tools/goctl/api/javagen"
	"github.com/5a6e/newzero/tools/goctl/api/ktgen"
	"github.com/5a6e/newzero/tools/goctl/api/new"
	"github.com/5a6e/newzero/tools/goctl/api/swagger"
	"github.com/5a6e/newzero/tools/goctl/api/tsgen"
	"github.com/5a6e/newzero/tools/goctl/api/validate"
	"github.com/5a6e/newzero/tools/goctl/config"
	"github.com/5a6e/newzero/tools/goctl/internal/cobrax"
	"github.com/5a6e/newzero/tools/goctl/plugin"
)
