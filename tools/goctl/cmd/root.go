...
import (
	...
	"github.com/5a6e/newzero/tools/goctl/api"
	"github.com/5a6e/newzero/tools/goctl/bug"
	"github.com/5a6e/newzero/tools/goctl/config"
	"github.com/5a6e/newzero/tools/goctl/docker"
	"github.com/5a6e/newzero/tools/goctl/env"
	"github.com/5a6e/newzero/tools/goctl/gateway"
	"github.com/5a6e/newzero/tools/goctl/internal/cobrax"
	"github.com/5a6e/newzero/tools/goctl/internal/version"
	"github.com/5a6e/newzero/tools/goctl/kube"
	"github.com/5a6e/newzero/tools/goctl/migrate"
	"github.com/5a6e/newzero/tools/goctl/model"
	"github.com/5a6e/newzero/tools/goctl/quickstart"
	"github.com/5a6e/newzero/tools/goctl/rpc"
	"github.com/5a6e/newzero/tools/goctl/tpl"
	"github.com/5a6e/newzero/tools/goctl/upgrade"
)
