...
import (
	...
	"github.com/5a6e/newzero/tools/goctl/example/rpc/hello/internal/config"
	greetServer "github.com/5a6e/newzero/tools/goctl/example/rpc/hello/internal/server/greet"
